...
class Esri9GisService extends EsriGisService{

	private static Logger _log = LoggerFactory.getLogger(Esri9GisService.class);
	...
	Map reverseGeoCode(Double xCoord, Double yCoord, String url, Integer distance = 5) {
		...
		return [street:result?.address?.Street?:"", zip:result?.address?.Zone?:""];
	}
	...
	public Map getPointLayersIntersection(String xCoord, String yCoord,
			List urls, Boolean returnGeometry) {
		// TODO Auto-generated method stub
		return null;
	}

	public Map getPointLayersIntersectionAttributes(String xCoord,
			String yCoord, List urls) {
		// TODO Auto-generated method stub
		return null;
	}


	public Map getPointLayersIntersectionGeometry(String xCoord, String yCoord,
			List urls) {
		// TODO Auto-generated method stub
		return null;
	}

...
//				'8721 SW 41ST ST, 33165']
	...
	@Test
	public void testGetCandidateAddresses_With_DistrictNumber_Expect_One_Candidates(){
		List candidatesAddress = addressService.getCandidateAddresses("11826 SW 97th Street", "", null, 7)
		assert candidatesAddress.size() == 1
	}

	@Test
	public void testGetCandidateAddresses_With_InvalidDistrictNumber_Expect_No_Candidates(){
		List candidatesAddress = addressService.getCandidateAddresses("11826 SW 97th Street", "", null, 2000)
		assert candidatesAddress.size() == 0

	}

	@Test
	public void testGetCandidateAddresses_Without_DistrictNumber_And_Expect_Five_Candidates_With_DistrictNumber(){
		List candidatesAddress = addressService.getCandidateAddresses("111 NW 1St", null,null,null, true)
	...
	@Test
	public void testGetCandidateAddresses_With_DistrictNumber_And_Expect_Five_Candidates_With_DistrictNumber(){
		List candidatesAddress = addressService.getCandidateAddresses("111 NW 1St", null,null,9, true)
		assert candidatesAddress.size() == 3
	...
	@Test
	public void testGetCandidateAddresses_Without_DistrictNumber_And_Expect_Five_Candidates_Without_DistrictNumber(){
		List candidatesAddress = addressService.getCandidateAddresses("111 NW 1St", null,null,null, false)
		assert candidatesAddress.size() == 5
	...
	@Test
	public void testGetCandidateAddresses_With_DistrictNumber_And_Expect_Three_Candidates_With_DistrictNumber(){
		List candidatesAddress = addressService.getCandidateAddresses("111 NW 1St",null,null,9,false)
		assert candidatesAddress.size() == 3

...
class PropertyInfoServiceTests {
	...
	public void testGetCondoPropertyInfo_NoData(){
		try {
			...
			String message = "Unexpected error for uri https://s0142354.miamidade.gov/ArcGIS/rest/services/Gic/MapServer/26/query | message: [error:[code:400, message:Failed to execute query., details:[]]]"

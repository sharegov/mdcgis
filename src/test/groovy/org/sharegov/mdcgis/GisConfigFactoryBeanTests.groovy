...
class GisConfigFactoryBeanTests {
	...
	public void testLoadLayers(){
		...
		assert config.gisServices.size() == 11
	...
	public void testLayers_getValueFromKey(){
		assert config.layers["pwd_lights"] == "http://311arcgis.miamidade.gov/arcgis/rest/services/Gic/MapServer/41/query"
	}
	
	@Test
	public void testLayers_GetKeyFromValue(){
		assert config.layers.getKey("http://311arcgis.miamidade.gov/arcgis/rest/services/Gic/MapServer/41/query") == "pwd_lights"
	}
